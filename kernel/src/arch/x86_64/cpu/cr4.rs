...
bitflags! {
    ...
    pub struct Features: u64 {
        ...
        /// Enable the use of 4 MiB pages in protected mode. In long mode,
        /// this flag is simply ignored.
        const PSE = 1 << 4;

        /// Enable physical address extension and 2 MiB pages. This
        ...
        /// user-mode pages: access to user-mode pages is denied when the AC
...
pub unsafe fn enable(features: Features) {
    let cr4: u64 = read().bits();
    core::arch::asm!("mov cr4, {}",
        in(reg) cr4 | features.bits(),
