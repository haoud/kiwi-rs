...
bitflags! {
      ...
      pub struct Features : u64 {
          ...
          /// Enable paging. This bit requires the `Self::PE` bit to be set.
...
pub unsafe fn enable(features: Features) {
    let cr0: u64 = read().bits();
    core::arch::asm!("mov cr0, {}",
        in(reg) cr0 | features.bits(),
...
/// Read the CR0 register and return the currently enabled features.
#[must_use]
