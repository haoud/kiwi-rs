...
/// A macro to indicate that a function is only used during the initialization of the
/// kernel. This macro will this attribute are put in a separate .init section. When
/// the kernel has been initialized, this section will be discarded and the memory
/// will be freed, allowing the kernel to reduce its memory footprint and enhance
/// cache locality.
///
/// # Safety
